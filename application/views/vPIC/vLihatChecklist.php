    ...
    <div class="ui segment" style="border-radius: 1.285714rem">
      ...
      <div class="segment">
        <div class="ui icon input" style="margin-left: 0px">
          <input type="text" placeholder="Search..." id="pencarianCheck">
...
<script type="text/javascript">
  ...
  function reloadChecklist(){
    ...
    var row = document.querySelectorAll("table#mytable>tbody#hasilCheck>tr");
    var blink = document.getElementById('hasilCheck');
    var time = [];
    var selisih = [];
    var batasP = [];
    var statusCheck = [];
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function cari()
    {
      $("#pencarianCheck").on("keyup", function() {
